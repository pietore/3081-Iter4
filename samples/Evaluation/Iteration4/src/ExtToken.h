...
// Let Kwd
class LetKwdToken : public ExtToken {
public:
    LetKwdToken (Parser *p, Token *t) : ExtToken(p,t) { }
...
public:
    ...
    ParseResult nud () { return parser->parseNestedOrTupleExpr () ; }
    ParseResult led (ParseResult left) {
        return parser->parseFunctionCall (left) ; 
    }
...
// Left Square
class LeftSquareToken : public ExtToken {
public:
    LeftSquareToken (Parser *p, Token *t) : ExtToken(p,t) { }

    ParseResult nud () { return parser->parseBraketListExpr () ; }
